...
- `explosions.player-units.ts` — конфіги вибухів, пов'язаних із юнітами.
...
- Додано тип `unitDeath` для ефектів смерті юнітів.
- Для емісій можна вказати `emissionDampingInterval` — тривалість (мс) лінійного затухання швидкості спавну під кінець `emissionDurationMs`. Нуль або відсутність вимикають демпфування.
