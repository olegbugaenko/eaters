...
- `NecromancerModule` — читає ресурси (mana та sanity як таймер), позиції спавнів і статус карти.
...
- `tryCastSpell(spellId, target)` — перевіряє розблокування, ресурси по мані, кулдаун, нормалізує ціль до меж карти, витрачає ресурси й викликає поведінку спела.
