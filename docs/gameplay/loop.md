...
- Некромант отримує повну шкалу мани й розуму (sanity), яка відраховує тривалість забігу, та може викликати юнітів через вибір дизайну або базового типу.
...
- Якщо sanity падає до нуля, забіг завершується поразкою, навіть якщо на полі лишились юніти або доступна мана.
...
## Автоперезапуск
- Після вивчення скіла `autorestart_rituals` відкривається меню автоперезапуску. Можна ввімкнути повторний старт або встановити поріг ефективних юнітів (живі + доступні для виклику за наявною маною в межах юніт-капу).
