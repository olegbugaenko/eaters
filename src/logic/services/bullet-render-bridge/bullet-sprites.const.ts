...
export const BULLET_SPRITE_NAMES = ["needle", "fireball", "magic_arrow", "energetic_strike"] as const;
export type BulletSpriteName = (typeof BULLET_SPRITE_NAMES)[number];

export const BULLET_SPRITE_PATHS = BULLET_SPRITE_NAMES.map(
  (name) => `/images/sprites/${name}.png`
);
