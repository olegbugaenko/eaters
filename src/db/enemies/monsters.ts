...
export const MONSTERS_ENEMIES: Partial<Record<EnemyType, EnemyConfig>> = {
      ...
      layers: [
        ...
        >(
          ...
          ],
          {
            ...
            groupId: "fossilGuardianTail",
            connectionSlots: [
              { id: "fossilGuardianTail1", mode: "spine", t: 0.35 },
              { id: "fossilGuardianTail2", mode: "spine", t: 0.62 },
              { id: "fossilGuardianTail3", mode: "spine", t: 0.83 },
            ],
          },
          { epsilon: 0.25, winding: "CCW" },
        ),
        ...
        >(
          ...
          {
            fill: { type: "base", brightness: 0.36 },
            anim: {
              type: "sway",
              periodMs: 1_050,
              amplitude: 4,
            ...
            join: { anchorId: "fossilGuardianTail1", targetGroupId: "fossilGuardianTail" },
          },
          { epsilon: 0.25, winding: "CCW" },
        ),
        ...mapLineToPolygonShape<
        ...
        >(
          ...
          ],
          {
            ...
            join: { anchorId: "fossilGuardianTail2", targetGroupId: "fossilGuardianTail" },
          },
          { epsilon: 0.25, winding: "CCW" },
        ),
        ...mapLineToPolygonShape<
  ...
  fireParasiteEnemy: {
    ...
    renderer: {
      ...
      layers: [
        ...
        // Heat glow
        {
          ...
          fill: {
            ...
            fill: {
              ...
              stops: [
                { offset: 0, color: { r: 1, g: 0.7, b: 0.25, a: 0.5 } },
                { offset: 0.55, color: { r: 1, g: 0.45, b: 0.1, a: 0.3 } },
                { offset: 1, color: { r: 1, g: 0.25, b: 0.0, a: 0.0 } },
              ],
            },
          },
        },
        ...
        >(
          ...
          {
            fill: { type: "base", brightness: 0.28 },
            stroke: { type: "base", width: 1.2, brightness: -0.1 },
            anim: {
              type: "sway",
              periodMs: 1100,
              amplitude: 5,
    ...
    streamAttack: {
      ...
      visual: {
        color: { r: 1, g: 0.56, b: 0.15, a: 0.78 },
        coreColor: { r: 1, g: 0.96, b: 0.72, a: 0.95 },
        edgeColor: { r: 0.95, g: 0.08, b: 0.0, a: 0.12 },
        widthStart: 8,
        widthEnd: 34,
        innerWidthMultiplier: 0.46,
        raggedness: 0.22,
        waveAmplitude: 0.34,
        waveFrequency: 2.4,
        pulseSpeed: 0.018,
        ...
        segments: 14,
        /**
         * Дефолти з `buildFlameEmitters` (EnemyStreamAttackController): три шари вогню + іскри.
         * `spread` для шарів 1–3 прив’язаний до `angleDeg` (30°) так само, як у коді:
         * `(angleDeg * π / 180) * множник`.
         * `emissionDurationMs` має збігатися з `streamAttack.durationMs`, якщо хочете повну довжину атаки.
         */
        flameEmitters: [
          {
            ...
            fadeStartMs: 340,
            fadeInMs: 30,
            emissionDurationMs: 1920,
            sizeRange: { min: 12, max: 28 },
            sizeEvolutionMult: 4.6,
            baseSpeed: 0.28,
            speedVariation: 0.06,
            spread: (30 * Math.PI / 180) * 1.1,
            offset: { x: 0, y: 0 },
            color: { r: 0.95, g: 0.08, b: 0.0, a: 0.28 },
            fill: {
              fillType: FILL_TYPES.RADIAL_GRADIENT,
              stops: [
                { offset: 0, color: { r: 0.3, g: 0.3, b: 0.2, a: 0.65 } },
                { offset: 0.35, color: { r: 0.3, g: 0.3, b: 0.2, a: 0.6 } },
                { offset: 1, color: { r: 0.3, g: 0.3, b: 0.2, a: 0 } },
              ],
              noise: {
                colorAmplitude: 0.0,
                alphaAmplitude: 0.02,
          ...
          },
          {
            ...
            particleLifetimeMs: 1220,
            fadeStartMs: 540,
            fadeInMs: 30,
            emissionDurationMs: 1920,
            sizeRange: { min: 22, max: 38 },
            sizeEvolutionMult: 3.6,
            baseSpeed: 0.21,
            speedVariation: 0.04,
            spread: (25 * Math.PI / 180) * 1.1,
            offset: { x: 0, y: 0 },
            color: { r: 0.95, g: 0.08, b: 0.0, a: 0.28 },
            fill: {
              fillType: FILL_TYPES.RADIAL_GRADIENT,
              stops: [
                { offset: 0, color: { r: 1, g: 0.36, b: 0.15, a: 0.35 } },
                { offset: 0.35, color: { r: 0.95, g: 0.28, b: 0.14, a: 0.2 } },
                { offset: 1, color: { r: 0.95, g: 0.18, b: 0.1, a: 0 } },
              ],
              noise: {
                colorAmplitude: 0.0,
                alphaAmplitude: 0.02,
            ...
            sizeEvolutionMult: 3.1,
            baseSpeed: 0.21,
            speedVariation: 0.04,
            spread: (10 * Math.PI / 180) * 1.1,
            offset: { x: 0, y: 0 },
            color: { r: 0.95, g: 0.08, b: 0.0, a: 0.28 },
            fill: {
              fillType: FILL_TYPES.RADIAL_GRADIENT,
              stops: [
                { offset: 0, color: { r: 1, g: 0.66, b: 0.35, a: 0.35 } },
                { offset: 0.35, color: { r: 0.95, g: 0.58, b: 0.34, a: 0.2 } },
                { offset: 1, color: { r: 0.95, g: 0.58, b: 0.3, a: 0 } },
              ],
              noise: {
                colorAmplitude: 0.0,
                alphaAmplitude: 0.02,
          ...
          },/*
          {
            ...
            baseSpeed: 0.32,
            speedVariation: 0.08,
            spread: (30 * Math.PI / 180) * 0.85,
            offset: { x: 0, y: 0 },
            color: { r: 1, g: 0.56, b: 0.15, a: 0.42 },
            fill: {
              fillType: FILL_TYPES.RADIAL_GRADIENT,
              stops: [
                { offset: 0, color: { r: 1, g: 0.96, b: 0.72, a: 0.55 } },
                { offset: 0.35, color: { r: 1, g: 0.56, b: 0.15, a: 0.3 } },
                { offset: 1, color: { r: 1, g: 0.56, b: 0.15, a: 0 } },
              ],
              noise: {
                colorAmplitude: 0.0,
                alphaAmplitude: 0.02,
          ...
          /*
          {
            ...
            baseSpeed: 0.36,
            speedVariation: 0.1,
            spread: (30 * Math.PI / 180) * 0.65,
            offset: { x: 0, y: 0 },
            color: { r: 1, g: 0.96, b: 0.72, a: 0.52 },
            fill: {
              fillType: FILL_TYPES.RADIAL_GRADIENT,
              stops: [
                { offset: 0, color: { r: 1, g: 0.96, b: 0.72, a: 0.75 } },
                { offset: 0.35, color: { r: 1, g: 0.96, b: 0.72, a: 0.4 } },
                { offset: 1, color: { r: 1, g: 0.96, b: 0.72, a: 0 } },
              ],
            },
            shape: "circle",
            maxParticles: 12,
          },
          {
            ...
            spread: Math.PI / 5,
            offset: { x: 0, y: 0 },
            sizeRange: { min: 5, max: 9 },
            sizeEvolutionMult: 0.65,
            color: { r: 1, g: 0.84, b: 0.35, a: 0.9 },
            fill: {
              fillType: FILL_TYPES.RADIAL_GRADIENT,
              stops: [
                { offset: 0, color: { r: 1, g: 0.98, b: 0.74, a: 0.32 } },
                { offset: 0.6, color: { r: 1, g: 0.62, b: 0.14, a: 0.18 } },
                { offset: 1, color: { r: 0.85, g: 0.12, b: 0.0, a: 0 } },
              ],
            },
            shape: "triangle",
        ...
        /** Якщо задано `flameEmitters`, рендер іде з нього; це поле лишається для автогенерації без `flameEmitters` і як дзеркало для 4-го шару — тримай узгодженим з останнім елементом `flameEmitters`. */
        sparks: {
          particlesPerSecond: 28,
          particleLifetimeMs: 1220,
          emissionDurationMs: 720,
          fadeStartMs: 220,
          fadeInMs: 40,
          baseSpeed: 0.11,
          speedVariation: 0.03,
    ...
    emitter: {
      particlesPerSecond: 55,
      particleLifetimeMs: 600,
      fadeStartMs: 180,
      baseSpeed: 0.05,
      speedVariation: 0.01,
      sizeRange: { min: 10, max: 20 },
      sizeEvolutionMult: 1.8,
      spread: Math.PI / 4,
      offset: { x: -0.5, y: 0 },
      color: { r: 1, g: 0.5, b: 0.1, a: 0.4 },
      fill: {
        fillType: FILL_TYPES.RADIAL_GRADIENT,
        start: { x: 0, y: 0 },
        stops: [
          { offset: 0, color: { r: 1, g: 0.8, b: 0.3, a: 0.11 } },
          { offset: 0.3, color: { r: 1, g: 0.55, b: 0.1, a: 0.05 } },
          { offset: 1, color: { r: 1, g: 0.35, b: 0.0, a: 0 } },
        ],
        noise: {
          colorAmplitude: 0.0,
          alphaAmplitude: 0.02,
