...
export const PROJECTILE_EXPLOSIONS: Partial<Record<ExplosionType, ExplosionConfig>> = {
  ...
  healWave: {
    ...
    starburst: {
      enabled: true,
      color: { r: 0.6, g: 1, b: 0.6, a: 0.95 },
      spikeCount: 7,
      spikeLength: { min: 11, max: 18 },
      spikeWidth: { min: 2.5, max: 3.5 },
      angleJitterDeg: 30,
      lengthJitter: 0.6,
      widthJitter: 0.38,
      lifetimeMs: 550,
  ...
  hotPlasmaExplosion: {
    ...
    waves: createSimpleWave({
      ...
      endAlpha: 0,
      gradientStops: [
        { offset: 0, color: { r: 1, g: 0.98, b: 0.75, a: 0.5 } },
        { offset: 0.45, color: { r: 1, g: 0.72, b: 0.25, a: 0.42 } },
        { offset: 1, color: { r: 0.95, g: 0.25, b: 0.05, a: 0.02 } },
      ],
    }),
    starburst: {
      enabled: true,
      color: { r: 1, g: 0.988, b: 0.88, a: 1 },
      spikeCount: 8,
      spikeLength: { min: 14, max: 33 },
      spikeWidth: { min: 4.5, max: 7.5 },
      angleJitterDeg: 30,
      lengthJitter: 0.6,
      widthJitter: 0.18,
      lifetimeMs: 950,
    ...
    emitter: {
      ...
      speedVariation: 0.04,
      fadeStartMs: 520,
      particleLifetimeMs: 1_300,
      particlesPerSecond: 3800,
      sizeRange: { min: 1.2, max: 2.8 },
      emissionDurationMs: 660,
      spawnRadius: { min: 0, max: 0.25 },
      spawnRadiusMultiplier: undefined,
      fill: createSolidEmitterFill({ r: 1, g: 0.72, b: 0.18, a: 1 }),
      radialVelocity: true,
      maxParticles: 3900,
    },
  },
  ...
  chainLightning: {
    ...
    starburst: {
      enabled: true,
      color: { r: 0.0, g: 0.6, b: 1, a: 0.5 },
      spikeCount: 5,
      spikeLength: { min: 8, max: 28 },
      spikeWidth: { min: 3.5, max: 5.5 },
      angleJitterDeg: 30,
      lengthJitter: 0.6,
      widthJitter: 0.18,
      lifetimeMs: 750,
