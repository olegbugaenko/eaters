    ...
    renderer: {
      ...
      layers: [
        ...
        // Burning tail (flame spine + glow)
        {
          ...
          fill: { type: "base", brightness: -0.06 },
          stroke: { type: "base", width: 1.8, brightness: -0.08 },
        },
        ...mapLineToPolygonShape<Omit<PlayerUnitRendererLayerConfig, "shape" | "vertices">>(
          [
            { x: -18.6, y: 0.2, width: 7.6 },
            { x: -26.8, y: 0.7, width: 5.3 },
            { x: -34.4, y: 0.1, width: 3.4 },
          ],
          {
            requiresModule: "burningTail",
            fill: { type: "base", brightness: -0.08 },
            stroke: { type: "base", width: 1.5, brightness: -0.14 },
        ...
        ...mapLineToPolygonShape<Omit<PlayerUnitRendererLayerConfig, "shape" | "vertices">>(
          [
            { x: -31.2, y: -0.2, width: 2.8 },
            { x: -35.0, y: -1.2, width: 1.9 },
          ],
          {
            requiresModule: "burningTail",
        ...
        ),
        {
          ...
          stroke: { type: "solid", width: 1.0, color: { r: 0.75, g: 0.22, b: 0.05, a: 1 } },
        },
        {
          shape: "circle",
          requiresModule: "burningTail",
        ...
        // Freezing tail (crystal spine + glow)
        {
          ...
          fill: { type: "base", brightness: -0.04 },
          stroke: { type: "base", width: 1.8, brightness: -0.06 },
        },
        ...mapLineToPolygonShape<Omit<PlayerUnitRendererLayerConfig, "shape" | "vertices">>(
          [
            { x: -18.2, y: -0.2, width: 7.0 },
            { x: -26.0, y: -0.9, width: 5.0 },
            { x: -33.2, y: -1.4, width: 3.1 },
          ],
          {
            requiresModule: "freezingTail",
            fill: { type: "base", brightness: -0.02 },
            stroke: { type: "base", width: 1.4, brightness: -0.08 },
        ...
        ...mapLineToPolygonShape<Omit<PlayerUnitRendererLayerConfig, "shape" | "vertices">>(
          [
            { x: -30.6, y: -1.2, width: 2.6 },
            { x: -34.0, y: -0.4, width: 1.7 },
          ],
          {
            requiresModule: "freezingTail",
        ...
        ),
        {
          ...
          stroke: { type: "solid", width: 1.0, color: { r: 0.24, g: 0.62, b: 0.95, a: 1 } },
        },
        {
          shape: "circle",
          requiresModule: "freezingTail",
