    ...
    renderer: {
      ...
      layers: [
        ...
        // Burning tail (flame spine + glow)
        {
          ...
          fill: { type: "base", brightness: -0.06 },
          stroke: { type: "base", width: 2.0, brightness: -0.08 },
        },
        ...mapLineToPolygonShape<Omit<PlayerUnitRendererLayerConfig, "shape" | "vertices">>(
          [
            { x: -18.4, y: 0.2, width: 10.4 },
            { x: -33.2, y: 1.1, width: 7.6 },
            { x: -48.0, y: 0.9, width: 5.2 },
            { x: -62.4, y: -0.6, width: 3.4 },
            { x: -76.2, y: -3.6, width: 2.2 },
          ],
          {
            requiresModule: "burningTail",
            fill: { type: "base", brightness: -0.08 },
            stroke: { type: "base", width: 1.6, brightness: -0.14 },
        ...
        ...mapLineToPolygonShape<Omit<PlayerUnitRendererLayerConfig, "shape" | "vertices">>(
          [
            { x: -57.2, y: -0.4, width: 3.6 },
            { x: -66.6, y: -2.0, width: 2.6 },
            { x: -75.4, y: -3.6, width: 1.7 },
          ],
          {
            requiresModule: "burningTail",
            fill: { type: "solid", color: { r: 1, g: 0.6, b: 0.24, a: 0.75 } },
            anim: { type: "sway", periodMs: 1700, amplitude: 4.6, falloff: "tip", axis: "normal", phase: 0.45 },
            groupId: "burningTail-glow",
          },
          { epsilon: 0.22, winding: "CCW" }
        ),
        {
          shape: "polygon",
          requiresModule: "burningTail",
        ...
        ...mapLineToPolygonShape<Omit<PlayerUnitRendererLayerConfig, "shape" | "vertices">>(
          [
            { x: -18.0, y: -0.2, width: 9.8 },
            { x: -31.8, y: -1.5, width: 6.8 },
            { x: -45.6, y: -2.2, width: 4.8 },
            { x: -59.2, y: -2.0, width: 3.2 },
            { x: -72.0, y: -0.6, width: 2.1 },
          ],
          {
            requiresModule: "freezingTail",
            fill: { type: "base", brightness: -0.02 },
            stroke: { type: "base", width: 1.6, brightness: -0.08 },
        ...
        ...mapLineToPolygonShape<Omit<PlayerUnitRendererLayerConfig, "shape" | "vertices">>(
          [
            { x: -56.8, y: -1.8, width: 3.2 },
            { x: -65.6, y: -1.2, width: 2.2 },
            { x: -73.8, y: 0.2, width: 1.4 },
          ],
          {
            requiresModule: "freezingTail",
            fill: { type: "solid", color: { r: 0.66, g: 0.95, b: 1, a: 0.78 } },
            anim: { type: "sway", periodMs: 1950, amplitude: 3.9, falloff: "tip", axis: "normal", phase: 0.5 },
